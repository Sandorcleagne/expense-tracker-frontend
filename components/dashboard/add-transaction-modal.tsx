...
import { DollarSign, FileText, Tag, Loader2, Wallet } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogHeader,
      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-md">
        ...
        {success ? (
          ...
          <form onSubmit={handleSubmit} className="mt-4 space-y-4">
              ...
              <div className="flex gap-2">
                {(["completed", "pending"] as const).map((s) => (
                  <button
                    ...
                    onClick={() => setStatus(s)}
                    className={cn(
                      "rounded-lg border px-4 py-2 text-sm font-medium capitalize transition-colors cursor-pointer",
                      status === s
            ...
            {/* Actions */}
            <div className="flex items-center justify-end gap-2 pt-2 cursor-pointer">
              <DialogClose asChild>
                <button
                  type="button"
              ...
              <button
                ...
                className={cn(
                  "inline-flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium text-white transition-colors disabled:cursor-not-allowed disabled:opacity-50 cursor-pointer",
                  type === "expense"
